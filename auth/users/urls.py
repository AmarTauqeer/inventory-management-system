...
from .views import RegisterView, LoginView, UserView, LogoutView, ActivateView, ActivationConfirm, ResetPasswordEmailView, ResetPasswordView, ResetPasswordConfirmView
urlpatterns = [
