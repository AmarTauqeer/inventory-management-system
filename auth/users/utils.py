...
def send_activation_email(recipient_email, activation_url):
    ...
    html_content = render_to_string('users/activation_email.html', {'activation_url': activation_url})
...
def send_reset_password_email(recipient_email, reset_url):
    ...
    html_content = render_to_string('users/reset_password_email.html', {'reset_url': reset_url})
