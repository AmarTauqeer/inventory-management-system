    ...
    <div className="flex flex-col m-2">
      <form>
        ...
        <div className="flex items-center m-4">
          ...
          <select
            className="outline-none ml-2 md:ml-0 text-sm md:text-md flex rounded py-1 shadow-sm ring-1 ring-inset w-48 
        ...
        {errors.purchase_rate && (
          <div className="flex items-center m-4">
            ...
            <div className="w-2/3 text-sm">
              <error className="text-red-400">
                {errors.purchase_rate?.message && errors.purchase_rate?.message}
              </error>
            </div>
          </div>
        )}
